...
namespace Dragonbones.Collections.Paged
{
    ...
    public class NameBuffer: IDataBuffer,  IEnumerable<Tuple<int,string>>
    {
        ...
        public NameBuffer(int pagePower = 8, int pageCount = 1, int hashSize = 47)
        {
            _buffer = new DataBuffer<Entry>(pagePower, pageCount);
        ...
        public void Constrict(int newCapacity)
        {
            ...
            _buffer.ShrinkTo(newCapacity - 1);
        }
        ...
        private class Enumerator : IEnumerator<Tuple<int,string>>
        {
            ...
            public bool MoveNext()
            {
                ...
                bool ret = _current != -1;
                Entry ent = _buff._buffer[_type, ret ? _current : 0];
